...
7070 PRINT : PRINT "         PRESS -SPACE- TO CONT.";: DO:GET Q$:LOOP WHILE Q$<>" ": FOR X = 0 TO 5:C(X) = C(X) + 1: NEXT : GRAPHIC 2,1,20 : GOTO 1090
...
60130 RETURN
60200 SYSCM,,11,0: PRINT "WELCOME TO THE ADVENTURE SHOP":WINDOW 0,12,39,15,1:?"{DOWN}{DOWN}"
